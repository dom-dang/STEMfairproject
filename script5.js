...
function buttonTwentyTwo(){
  document.getElementById("demoFive").innerHTML="1/11/2020 Today I printed out the photographs and graphs and data tables for Set 1. I started to tape and cut them out, i also wrote my Analysis for mydata and I plant to print and tape in the required items for Set 2 and 3 soon. My second experiment is not going so well. Seeds are germinated in the control and rock sand but not for any of the chemical based deciers (again). Even with the lower and backup 5% concentration, none of the seeds are growing. The seeds in the backup backup plan are growing so I am ready to go to that plan if neccessary. Hopefully it does not come to that and I can get my experiment data for Set 1- Experiment II done before the due date.";
}
